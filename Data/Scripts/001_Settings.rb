...
module Settings
  ...
  BREEDING_CAN_INHERIT_EGG_MOVES_FROM_MOTHER = true
...
#    ["Deutsch", "deutsch"]
  ...
  def self.game_credits
    return [
      _INTL("Pokemon Infinite by:"),
      "supersand24",
      "",
      _INTL("Special Thanks to:"),
      "Pokemon Essentials<s>Maruno",
      "",
      _INTL("Art:"),
      "Gen 4 Character Assets<s>PurpleZaffre",
      "Automatic Level Scaling<s>Benitex",
      "",
      _INTL("Also Thanks to:"),
      "Thieving Items into Bag<s>Appletun",
      "",
      _INTL("Alpha/Beta Testers:"),
      "sqKweglord",
    ]
  end
end
